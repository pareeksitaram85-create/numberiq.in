      ...
      <main className="flex-1 pt-8 sm:pt-8 pb-20 px-6 max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
            ...
            <TiltCard>
              <Link href="/tools" className="block h-full group">
                <div className="h-full min-h-[220px] relative rounded-3xl overflow-hidden border border-[#4f7cff]/20 bg-gradient-to-br from-[#0a0f1e] to-[#050810] p-7 flex flex-col justify-between transition-all duration-300 group-hover:border-[#4f7cff]/40 group-hover:shadow-[0_0_40px_rgba(79,124,255,0.1)]">
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-base font-bold text-white mb-1.5 group-hover:text-[#4f7cff] transition-colors">Finance Tools</h3>
            ...
            <TiltCard>
              <Link href="/insights" className="block h-full group">
                <div className="h-full min-h-[220px] relative rounded-3xl overflow-hidden border border-[#34d399]/20 bg-gradient-to-br from-[#06120e] to-[#050810] p-7 flex flex-col justify-between transition-all duration-300 group-hover:border-[#34d399]/40 group-hover:shadow-[0_0_40px_rgba(52,211,153,0.08)]">
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-base font-bold text-white mb-1.5 group-hover:text-[#34d399] transition-colors">Insights</h3>
                    <p className="text-xs text-[#737c92] leading-relaxed">CA analysis on GST circulars, ITA 2025, and compliance timelines.</p>
                  </div>
            ...
            <TiltCard>
              <Link href="/glossary" className="block h-full group">
                <div className="h-full min-h-[220px] relative rounded-3xl overflow-hidden border border-[#f4b740]/20 bg-gradient-to-br from-[#130e03] to-[#050810] p-7 flex flex-col justify-between transition-all duration-300 group-hover:border-[#f4b740]/40 group-hover:shadow-[0_0_40px_rgba(244,183,64,0.08)]">
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-base font-bold text-white mb-1.5 group-hover:text-[#f4b740] transition-colors">Glossary</h3>
                    <p className="text-xs text-[#737c92] leading-relaxed">200+ statutory terms — GST to FEMA, explained in plain English.</p>
                  </div>
        ...
        <section id="services" className="py-24 border-t border-white/5 relative overflow-hidden">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-xs sm:text-sm text-[#737c92] mt-4 max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
            {practicePillars.map((pillar) => (
              <TiltCard key={pillar.name} className="h-full">
                <Link href={pillar.href} className="block h-full group">
                  <div
                    className="h-full min-h-[300px] relative rounded-3xl overflow-hidden border p-7 flex flex-col justify-between transition-all duration-500 bg-gradient-to-br from-[#07091a] via-[#050810] to-[#050505]"
                    style={{
                      borderColor: `${pillar.tone}33`,
